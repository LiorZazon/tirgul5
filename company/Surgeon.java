...
public class Surgeon extends Doctor {
    ...
    public Surgeon(int m_doctor_id, String m_doctor_full_name, String m_hospital, String m_department, int m_yearsOfExperience) {
        super(m_doctor_id, m_doctor_full_name, m_hospital);
